export default function Chat() {
  return (
    <div className="bg-stone-100 h-[calc(100vh-4rem)] lg:ml-1">
      <div className="flex bg-indigo-100 my-2 mx-10 p-1 rounded-full items-center place-content-around">
        <div>
          ...
          <label
            for="1"
            className="block text-indigo-500 font-bold cursor-pointer select-none rounded-full py-1 px-7 text-center peer-checked:bg-indigo-500 peer-checked:text-indigo-100 transition-transform transform hover:scale-110"
          >
            Members
          </label>
        </div>
      ...
      <div className="h-[calc(100vh-11rem)]"></div>
      <div className="flex bg-white rounded-full h-10 p-2 m-2 items-center place-content-between">
        <svg
